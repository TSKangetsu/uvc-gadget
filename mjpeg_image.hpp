#ifndef MJPEG_IMAGE_HPP
#define MJPEG_IMAGE_HPP

// A tiny 1x1 black JPEG image
unsigned char mjpeg_image_data[] = {
  ...
  0x00, 0x3f, 0x00, 0xfc, 0x21, 0x80, 0xff, 0xd9
};
unsigned int mjpeg_image_data_len = 623;

#endif // MJPEG_IMAGE_HPP